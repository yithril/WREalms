...
namespace WanderlustRealms.Data.Migrations
{
    ...
    [Migration("20200327222544_LanguageUpgrade")]
    partial class LanguageUpgrade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Living.Language", b =>
                {
                    ...
                    b.Property<double>("LanguageModifier")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Living.LivingLanguage", b =>
                {
                    b.Property<int>("LanguageID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("LanguageID", "LivingID");

                    b.HasIndex("LivingID");

                    b.ToTable("LivingLanguages");
                });

            modelBuilder.Entity("WanderlustRealms.Models.Living.RaceLanguage", b =>
                {
                    b.Property<int>("LanguageID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Quests.Quest", b =>
                {
                    ...
                    b.Property<string>("QuestStartDialogue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Training.TrainerPreReq", b =>
                {
                    b.Property<int>("TrainerPreReqID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TrainerPreReqs");
                });

            modelBuilder.Entity("WanderlustRealms.Models.Training.TrainerSkill", b =>
                {
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Living.LivingLanguage", b =>
                {
                    b.HasOne("WanderlustRealms.Models.Living.Language", "Language")
                        .WithMany()
            ...
            modelBuilder.Entity("WanderlustRealms.Models.Living.RaceLanguage", b =>
                {
                    b.HasOne("WanderlustRealms.Models.Living.Language", "Langueage")
                        .WithMany()
                        .HasForeignKey("LanguageID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
