...
namespace WanderlustRealms.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LanguageID,Name,Adjective,Adjective2,LanguageModifier")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LanguageID,Name,Adjective,Adjective2,LanguageModifier")] Language language)
        {
